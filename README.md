...
(For GitHub CI specifically, `gh run watch` is a simpler option. But this is a general technique that works well even when you don't have a dedicated wait command handy.)
